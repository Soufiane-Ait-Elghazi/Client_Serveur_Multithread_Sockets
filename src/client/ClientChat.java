...
public class ClientChat extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Label lableMessage =new Label("Message :");
		TextField textFieldMessage = new TextField();
		textFieldMessage.setPrefSize(400, 25);
		Button buttonEnvoyer = new Button("Envoyer");
		HBox hbox2 = new HBox();
		hbox2.getChildren().addAll(lableMessage,textFieldMessage,buttonEnvoyer);
		hbox2.setSpacing(20);
